---
title: "What Counts as PHI in a Small Clinic"
description: "A direct explanation of what protected health information includes, where it appears outside the chart, and how healthcare teams accidentally create PHI in ordinary workflows."
metaDescription: "What counts as PHI Plain-language guide to where patient information becomes regulated and how healthcare teams mishandle it."
...
intent: "awareness"
summary: "PHI is identifiable information tied to a person's health, care, or payment for care. In practice it shows up far beyond the chart, including in tasks, messages, spreadsheets, forms, and operational notes. It helps clinics turn HIPAA requirements into assigned owners, recurring reviews, dated evidence, and practical controls that can be explained during an OCR inquiry."
keyTakeaways:
  - "PHI combines identifiable information with health, treatment, or payment context."
  - "Operational systems outside the EHR can still become PHI systems."
  - "The safest practical rule is to treat patient-linked workflow data as regulated unless proven otherwise."
author: "angel-campa"
...
sources:
  ...
  - title: "Security Rule Guidance Material"
    ...
    publisher: "HHS"
faq:
  - q: "Is a patient's first name alone PHI?"
    a: "Not by itself. The issue is whether the information identifies the person and connects them to health, treatment, or payment information."
  - q: "Can a task title contain PHI?"
    a: "Yes. A task title like 'Call Maria R. about biopsy results' can expose PHI in the task system and in notification channels."
---
...
Use [PHI Fundamentals](/learn/phi-fundamentals) for the broader definition cluster, [PHI in Email](/learn/phi-workflows/phi-in-email) for one common workflow, and [PHI vendor guides](/resources/guides) if your team is screening a specific tool.
